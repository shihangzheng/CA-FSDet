...
class FewShotNWPUV2Dataset(BaseFewShotDataset):
    ...
    def load_annotations_xml(
        ...
        for idx_, img_name in enumerate(img_names):
            ...
            img_id = img_name
            filename = f'NWPU2017/JPEGImages/{img_name.strip()}.jpg'
